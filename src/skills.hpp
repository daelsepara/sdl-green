...
namespace Skill
{
    ...
    auto ARCHERY = Skill::Base("ARCHERY", "A long-range attack skill. You must possess a LONGBOW to use this skill.", Skill::Type::ARCHERY, Item::Type::LONGBOW);
    ...
    std::vector<Skill::Base> ALL = {Skill::AGILITY, Skill::ARCHERY, Skill::CHARMS, Skill::CUNNING, Skill::FOLKLORE, Skill::ROGUERY, Skill::SPELLS, Skill::STREETWISE, Skill::SWORDPLAY, Skill::UNARMED_COMBAT, Skill::WILDERNESS_LORE};
